      ...
      <div className="w-full flex grid-cols-1 gap-8 items-center justify-center">
        <div className="bg-gray-900 border border-gray-800/80 rounded-2xl p-6 shadow-xl w-full md:w-1/2 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {imagePreview ? (
                ...
                <label 
                  ...
                  className="border border-dashed block border-gray-800 hover:border-emerald-500/30 bg-gray-950/30 hover:bg-emerald-500/5 cursor-pointer rounded-xl p-6 text-center transition-all group"
                >
            ...
            <button
              type="submit"
              disabled={isSubmitting || (!captionText.trim() && !selectedImage)}
